...
protected:
  ...
  //! Full Constructor
  RobotLink(double a, double alpha, double d, double theta, double robot2dh_offset, bool robot2dh_flip,
  ...
  RobotLink(double a, double alpha, double d, double theta, double robot2dh_offset = 0.0, bool robot2dh_flip = false,
