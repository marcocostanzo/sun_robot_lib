...
Clik6DQuaternionSingleRobot::Clik6DQuaternionSingleRobot(
    const std::shared_ptr<Robot> &robot)
    : ClikSingleRobot(robot) {}
...
const sun::UnitQuaternion &
Clik6DQuaternionSingleRobot::getCurrentQuaternion() const {
  return currentQuaternion_;
}
...
TooN::Vector<>
Clik6DQuaternionSingleRobot::getClikError(const TooN::Vector<> &q_DH) {
...
TooN::Matrix<>
Clik6DQuaternionSingleRobot::getClikJacobian(const TooN::Vector<> &q_DH) {
  return robot_->jacob_geometric(q_DH);
}
TooN::Vector<> Clik6DQuaternionSingleRobot::getDesiredCartesianTwist(
